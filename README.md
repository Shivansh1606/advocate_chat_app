Of course! Here is a complete and updated `README.md` file in English for your project. It explains everything from setup to functionality, file by file.

You can directly copy this and add it to your project as `README.md`.
